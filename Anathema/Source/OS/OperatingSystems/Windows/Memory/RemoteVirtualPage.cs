...
namespace Anathema.Source.OS.OperatingSystems.Windows.Memory
{
    ...
    public class RemoteVirtualPage : RemotePointer, IEquatable<RemoteVirtualPage>
    {
        ...
        {
            get { return MemoryCore.Query(WindowsOSInterface.Handle, BaseAddress); }
        }
        ...
        internal RemoteVirtualPage(WindowsOSInterface WindowsOSInterface, IntPtr BaseAddress) : base(WindowsOSInterface, BaseAddress)
        {
        ...
        {
            return new MemoryProtection(WindowsOSInterface, BaseAddress, (Int32)Information.RegionSize, Protection, MustBeDisposed);
        }
        ...
        {
            return BaseAddress.GetHashCode() ^ WindowsOSInterface.GetHashCode() ^ Information.RegionSize.GetHashCode();
        }
        ...
        {
            // Release the memory
            MemoryCore.Free(WindowsOSInterface.Handle, BaseAddress);
