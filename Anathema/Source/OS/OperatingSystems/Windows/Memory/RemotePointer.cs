...
namespace Anathema.Source.OS.OperatingSystems.Windows.Memory
{
    ...
    public class RemotePointer : IEquatable<RemotePointer>
    {
        ...
        {
            get { return WindowsOSInterface.IsRunning && BaseAddress != IntPtr.Zero; }
        }
        /// <summary>
        /// The reference of the <see cref="MemoryManagement.WindowsOSInterface"/> object.
        /// </summary>
        public WindowsOSInterface WindowsOSInterface { get; protected set; }
        ...
        {
            return new MemoryProtection(WindowsOSInterface, BaseAddress, Size, Protection, MustBeDisposed);
        }
        ...
        public bool Equals(RemotePointer other)
        {
            ...
            return ReferenceEquals(this, other) || (BaseAddress.Equals(other.BaseAddress) && WindowsOSInterface.Equals(other.WindowsOSInterface));
        }
        ...
        {
            return BaseAddress.GetHashCode() ^ WindowsOSInterface.GetHashCode();
        }
        ...
        {
            return WindowsOSInterface.Read<T>(BaseAddress + Offset, out Success);
        }
        ...
        {
            return WindowsOSInterface.Read<T>(BaseAddress + Offset, Count, out Success);
        }
        ...
        {
            return WindowsOSInterface.ReadString(BaseAddress + Offset, Encoding, out Success, MaxLength);
        }
        ...
        {
            return WindowsOSInterface.ReadString(BaseAddress + Offset, out Success, MaxLength);
        }
        ...
        {
            WindowsOSInterface.Write(BaseAddress + Offset, Value);
        }
        ...
        {
            WindowsOSInterface.Write(BaseAddress + Offset, Array);
        }
        ...
        {
            WindowsOSInterface.WriteString(BaseAddress + Offset, Text, Encoding);
        }
        ...
        {
            WindowsOSInterface.WriteString(BaseAddress + Offset, Text);
        }
