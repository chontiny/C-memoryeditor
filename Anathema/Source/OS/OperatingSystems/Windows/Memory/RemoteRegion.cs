...
namespace Anathema.Source.OS.OperatingSystems.Windows.Memory
{
    ...
    public class RemoteRegion : RemotePointer, IEquatable<RemoteRegion>
    {
        ...
        public RemoteRegion(WindowsOSInterface WindowsOSInterface, IntPtr BaseAddress, Int32 RegionSize) : base(WindowsOSInterface, BaseAddress)
        {
        ...
        {
            return BaseAddress.GetHashCode() ^ WindowsOSInterface.GetHashCode() ^ RegionSize.GetHashCode();
        }
