...
namespace Anathema.Source.OS.OperatingSystems.Windows.Internals
{
 ...
 TypeCode == TypeCode.Boolean ||
        ...
        public static T PtrToObject(WindowsOSInterface WindowsOSInterface, IntPtr Pointer)
        {
            Boolean ReadSuccess;
            return ByteArrayToObject(CanBeStoredInRegisters ? BitConverter.GetBytes(Pointer.ToInt64()) : WindowsOSInterface.Read<Byte>(Pointer, Size, out ReadSuccess));
        }
