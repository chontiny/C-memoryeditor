...
namespace Anathema.Source.Engine.OperatingSystems.Windows.Memory
{
    ...
    public class RemoteVirtualPage : RemotePointer, IEquatable<RemoteVirtualPage>
    {
        ...
        {
            get { return MemoryCore.Query(WindowsOperatingSystem.Handle, BaseAddress); }
        }
        ...
        internal RemoteVirtualPage(WindowsOperatingSystem WindowsOSInterface, IntPtr BaseAddress) : base(WindowsOSInterface, BaseAddress)
        {
        ...
        {
            return new MemoryProtection(WindowsOperatingSystem, BaseAddress, (Int32)Information.RegionSize, Protection, MustBeDisposed);
        }
        ...
        {
            return BaseAddress.GetHashCode() ^ WindowsOperatingSystem.GetHashCode() ^ Information.RegionSize.GetHashCode();
        }
        ...
        {
            // Release the memory
            MemoryCore.Free(WindowsOperatingSystem.Handle, BaseAddress);
