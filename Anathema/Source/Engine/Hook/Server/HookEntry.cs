using Anathema.Source.Engine.Graphics.DirectX.Interface;
using Anathema.Source.Engine.Graphics.DirectX.Interface.DX11;
using Anathema.Source.Engine.Graphics.DirectX.Interface.DX9;
using EasyHook;
using System;
...
namespace Anathema.Source.Engine.Hook.Server
{
    /// <summary>
