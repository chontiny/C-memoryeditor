...
namespace Anathema.Source.SystemInternals.InputCapture.MouseKeyHook.WinApi
{
    internal static class KeyboardNativeMethods
    {
        ...
        // Used to pass Unicode characters as if they were keystrokes. The VK_PACKET key is low word of a 32-bit Virtual Key value used for non-keyboard input methods
        private static Int32 LastVirtualKeyCode = 0;
        private static Int32 LastScanCode = 0;
        private static Byte[] LastKeyState = new Byte[255];
        private static Boolean LastIsDead = false;

        /// <summary>
        /// Translates a virtual key to its character equivalent using the current keyboard layout without knowing the scancode in advance.
        /// </summary>
        /// <param name="VirtualKeyCode"></param>
        /// <param name="FUState"></param>
        /// <param name="Chars"></param>
        /// <returns></returns>
        internal static void TryGetCharFromKeyboardState(Int32 VirtualKeyCode, Int32 FUState, out Char[] Chars)
        {
            IntPtr DWHKL = GetActiveKeyboard();
            Int32 ScanCode = MapVirtualKeyEx(VirtualKeyCode, (Int32)MapType.MAPVK_VK_TO_VSC, DWHKL);
        ...
        /// <param name="Chars"></param>
        /// <returns></returns>
        internal static void TryGetCharFromKeyboardState(Int32 VirtualKeyCode, Int32 ScanCode, Int32 FUState, out Char[] Chars)
        {
            IntPtr DWHKL = GetActiveKeyboard();
        ...
        /// <param name="Chars"></param>
        /// <returns></returns>
        internal static void TryGetCharFromKeyboardState(Int32 VirtualKeyCode, Int32 ScanCode, Int32 FUState, IntPtr DWHKL, out Char[] Chars)
        {
            ...
            Int32 RelevantChars = ToUnicodeEx(VirtualKeyCode, ScanCode, CurrentKeyboardState, PWSZBuff, PWSZBuff.Capacity, FUState, DWHKL);
        ...
        private static void ClearKeyboardBuffer(Int32 VK, Int32 SC, IntPtr HKL)
        {
            ...
            do
            {
                ...
                RC = ToUnicodeEx(VK, SC, LPKeyStateNull, StringBuilder, StringBuilder.Capacity, 0, HKL);
            } while (RC < 0);
        }
        ...
        private static IntPtr GetActiveKeyboard()
        {
            ...
            Int32 DWProcessId;
            Int32 HCurrentWnd = ThreadNativeMethods.GetWindowThreadProcessId(HActiveWnd, out DWProcessId);
        ...
        public static extern Int32 ToAscii(Int32 UVirtKey, Int32 UScanCode, Byte[] LPBKeyState, Byte[] LPWTransKey, Int32 FUState);
        ...
        /// </returns>
        [DllImport("user32.dll")]
        public static extern Int32 ToUnicodeEx(Int32 WVirtKey, Int32 WScanCode, Byte[] LPKeyState,
            [Out, MarshalAs(UnmanagedType.LPWStr, SizeConst = 64)] StringBuilder PWSZBuff,
            Int32 CCHBuff, Int32 WFlags, IntPtr DWHKL);
        ...
        /// </param>
        /// <param name="UMapType">
        /// [in] The translation to be performed. The value of this parameter depends on the value of the uCode parameter.
        /// </param>
        /// <param name="DWHKL">[in] The input locale identifier used to translate the specified code.</param>
        /// <returns></returns>
        [DllImport("user32.dll", CharSet = CharSet.Auto)]
        internal static extern Int32 MapVirtualKeyEx(Int32 UCode, Int32 UMapType, IntPtr DWHKL);
        ...
        /// </returns>
        [DllImport("user32.dll", CharSet = CharSet.Auto)]
        internal static extern IntPtr GetKeyboardLayout(Int32 DWLayout);
