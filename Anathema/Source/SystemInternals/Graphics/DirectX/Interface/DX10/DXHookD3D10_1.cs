...
namespace Anathema.Source.SystemInternals.Graphics.DirectX.Interface.DX10
{
    /// <summary>
    ...
    internal class DXHookD3D10_1 : BaseDXHook
    {
        ...
        public DXHookD3D10_1(DirextXGraphicsInterface GraphicsInterface) : base(GraphicsInterface)
        {
            D3D10_1VirtualTableAddresses = null;
            DXGISwapChainVirtualTableAddresses = null;
            DXGISwapChainPresentHook = null;
            DXGISwapChainResizeTargetHook = null;
        }

        protected override String HookName { get { return "DXHookD3D10_1"; } }

        public override void Hook()
        {
            // Determine method addresses in Direct3D10.Device, and DXGI.SwapChain
            if (D3D10_1VirtualTableAddresses == null)
            {
                D3D10_1VirtualTableAddresses = new List<IntPtr>();
        ...
        Int32 ResizeTargetHook(IntPtr SwapChainPtr, ref ModeDescription NewTargetParameters)
        {
            ...
            // using (SwapChain SwapChain = SwapChain.FromPointer(SwapChainPtr))
            {
