        ...
        private void DrawTab_Document(Graphics g, TabVS2012Light tab, Rectangle rect)
        {
            ...
            if (DockPane.ActiveContent == tab.Content)
            {
                if (DockPane.IsActiveDocumentPane)
                {
                    ...
                    g.DrawImage(rectCloseButton == ActiveClose ? ThemeVS2012Light.Resources.ActiveTabHover_Close : ThemeVS2012Light.Resources.ActiveTab_Close, rectCloseButton);
                }
                else
                {
                    ...
                    g.DrawImage(rectCloseButton == ActiveClose ? ThemeVS2012Light.Resources.LostFocusTabHover_Close : ThemeVS2012Light.Resources.LostFocusTab_Close, rectCloseButton);
                }
            }
            else
            {
                if (tab.Content == DockPane.MouseOverTab)
                {
                    ...
                    TextRenderer.DrawText(g, tab.Content.DockHandler.TabText, TextFont, rectText, activeText, DocumentTextFormat);
                    g.DrawImage(rectCloseButton == ActiveClose ? ThemeVS2012Light.Resources.InactiveTabHover_Close : ThemeVS2012Light.Resources.ActiveTabHover_Close, rectCloseButton);
                }
                else
                {
