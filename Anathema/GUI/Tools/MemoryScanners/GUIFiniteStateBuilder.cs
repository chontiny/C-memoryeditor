...
namespace Anathema.GUI.Tools.MemoryScanners
{
    public partial class GUIFiniteStateBuilder : UserControl, IFiniteStateBuilderView
    {
        ...
        private void FSMBuilderPanel_MouseUp(Object Sender, MouseEventArgs E)
        {
            ...
            FiniteStateBuilderPresenter.FinishAction(E.Location, ValueTextBox.Text.ToString());
        }
        ...
        {
            FiniteStateBuilderPresenter.SetToStartState(RightClickLocation);
        }

        private void NoEventToolStripMenuItem_Click(Object Sender, EventArgs E)
        {
            FiniteStateBuilderPresenter.SetStateEvent(RightClickLocation, FiniteState.StateEventEnum.None);
        }

        private void MarkValidToolStripMenuItem_Click(Object Sender, EventArgs E)
        {
            FiniteStateBuilderPresenter.SetStateEvent(RightClickLocation, FiniteState.StateEventEnum.MarkValid);
        }

        private void MarkInvalidToolStripMenuItem_Click(Object Sender, EventArgs E)
        {
            FiniteStateBuilderPresenter.SetStateEvent(RightClickLocation, FiniteState.StateEventEnum.MarkInvalid);
        }

        private void EndScanToolStripMenuItem_Click(Object Sender, EventArgs E)
        {
            FiniteStateBuilderPresenter.SetStateEvent(RightClickLocation, FiniteState.StateEventEnum.EndScan);
        }

        private void DeleteStateToolStripMenuItem_Click(Object Sender, EventArgs E)
        {
            FiniteStateBuilderPresenter.DeleteAtPoint(RightClickLocation);
        }
