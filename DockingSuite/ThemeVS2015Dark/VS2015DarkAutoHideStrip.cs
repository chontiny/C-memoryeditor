...
{
    internal class VS2015DarkAutoHideStrip : AutoHideStripBase
    {
        private class TabVS2015Dark : Tab
        {
            internal TabVS2015Dark(IDockContent content)
                : base(content)
            {
            }
        ...
        public VS2015DarkAutoHideStrip(DockPanel panel)
            : base(panel)
        {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.FillRectangle(new SolidBrush(colorTable.MenuStripGradientBegin), ClientRectangle);
            DrawTabStrip(g);
        }
        ...
        private void DrawTabStrip(Graphics g, DockState dockState)
        {
            ...
            {
                foreach (TabVS2015Dark tab in pane.AutoHideTabs)
                    DrawTab(g, tab);
            }
        ...
        private GraphicsPath GetTabOutline(TabVS2015Dark tab, bool transformed, bool rtlTransform)
        {
        ...
        private void DrawTab(Graphics g, TabVS2015Dark tab)
        {
        ...
        private Rectangle GetTabRectangle(TabVS2015Dark tab)
        {
            return GetTabRectangle(tab, false);
        }

        private Rectangle GetTabRectangle(TabVS2015Dark tab, bool transformed)
        {
            DockState dockState = tab.Content.DockHandler.DockState;
            Rectangle rectTabStrip = GetLogicalTabStripRectangle(dockState);
        ...
        {
            GraphicsPath path = GetTabOutline((TabVS2015Dark)tab, true, true);
        ...
        private TabVS2015Dark lastSelectedTab = null;

        protected override void OnMouseHover(EventArgs e)
        {
            var tab = (TabVS2015Dark)TabHitTest(PointToClient(MousePosition));
            if (tab != null)
            {
        ...
        {
            return new TabVS2015Dark(content);
        }
    }
}
