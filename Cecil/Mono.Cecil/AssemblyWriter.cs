...
namespace Mono.Cecil {
    ...
    public sealed class ModuleTable : OneRowTable<ModuleRow> {
    ...
    public sealed class AssemblyTable : OneRowTable<AssemblyRow> {
    ...
    public sealed class DocumentTable : MetadataTable<DocumentRow> {
    ...
    public sealed class MethodDebugInformationTable : MetadataTable<MethodDebugInformationRow> {
    ...
    public sealed class LocalScopeTable : MetadataTable<LocalScopeRow> {
    ...
    public sealed class LocalVariableTable : MetadataTable<LocalVariableRow> {
    ...
    public sealed class LocalConstantTable : MetadataTable<LocalConstantRow> {
    ...
    public sealed class ImportScopeTable : MetadataTable<ImportScopeRow> {
    ...
    public sealed class StateMachineMethodTable : MetadataTable<StateMachineMethodRow> {
    ...
    public sealed class CustomDebugInformationTable : MetadataTable<CustomDebugInformationRow> {
