...
using Squalr.Wpf.AvalonDock.Layout;
using Squalr.Wpf.AvalonDock.Converters;
using System.Diagnostics;
using System.Windows.Controls.Primitives;
using Squalr.Wpf.AvalonDock.Commands;
using Microsoft.Windows.Shell;

namespace Squalr.Wpf.AvalonDock.Controls
{
    public class LayoutAnchorableFloatingWindowControl : LayoutFloatingWindowControl, IOverlayWindowHost
    {
        ...
        internal override void UpdateThemeResources( Squalr.Wpf.AvalonDock.Themes.Theme oldTheme = null )
        {
