...
namespace Anathena.Source.Engine.OperatingSystems.Windows.Internals
{
    ...
    public static class MarshalValue
    {
        ...
        public static MarshalledValue<T> Marshal<T>(WindowsOperatingSystem WindowsOperatingSystem, T Value)
        {
            return new MarshalledValue<T>(WindowsOperatingSystem, Value);
        }
    }
    ...
    public class MarshalledValue<T> : IMarshalledValue
    {
        ...
        /// <param name="Value">The value to marshal.</param>
        public MarshalledValue(WindowsOperatingSystem WindowsOperatingSystem, T Value)
        {
            // Save the parameters
        ...
        private void Marshal()
        {
            ...
            if (typeof(T) == typeof(String))
            {
                ...
                Allocated = WindowsOperatingSystem.Memory.Allocate(Text.Length + 1);
            ...
            else
            {
                ...
                else
                {
                    ...
                    Allocated = WindowsOperatingSystem.Memory.Allocate(MarshalType<T>.Size);
