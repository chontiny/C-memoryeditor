...
namespace Anathena.Source.Engine.OperatingSystems.Windows.Memory
{
    ...
    public class RemoteRegion : RemotePointer, IEquatable<RemoteRegion>
    {
        ...
        public RemoteRegion(WindowsOperatingSystem WindowsOperatingSystem, IntPtr BaseAddress, Int32 RegionSize) : base(WindowsOperatingSystem, BaseAddress)
        {
        ...
        {
            return BaseAddress.GetHashCode() ^ WindowsOperatingSystem.GetHashCode() ^ RegionSize.GetHashCode();
        }
