...
namespace Anathena.Source.Engine.OperatingSystems.Windows.Memory
{
    ...
    public class MemoryProtection : IDisposable
    {
        ...
        /// </summary>
        private readonly WindowsOperatingSystem _WindowsOperatingSystem;
        /// <summary>
        ...
        {
            // Save the parameters
            _WindowsOperatingSystem = WindowsOperatingSystem;
            ...
            OldProtection = MemoryCore.ChangeProtection(_WindowsOperatingSystem.Handle, BaseAddress, Size, Protection);
        }
        ...
        public virtual void Dispose()
        {
            ...
            MemoryCore.ChangeProtection(_WindowsOperatingSystem.Handle, BaseAddress, Size, OldProtection);
