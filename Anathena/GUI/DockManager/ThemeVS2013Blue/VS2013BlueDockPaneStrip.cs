        ...
        private void DrawTab_Document(Graphics g, TabVS2013Light tab, Rectangle rect)
        {
            ...
            if (DockPane.ActiveContent == tab.Content)
            {
                ...
                else
                {
                    ...
                    g.DrawImage(rectCloseButton == ActiveClose ? ThemeVS2012Light.Resources.ActiveTabHover_Close : ThemeVS2012Light.Resources.LostFocusTab_Close, rectCloseButton);
                }
            }
            else
            {
                if (tab.Content == DockPane.MouseOverTab)
                {
                    ...
                    g.DrawImage(ThemeVS2012Light.Resources.ActiveTabHover_Close, rectCloseButton);
                }
                else
                {
