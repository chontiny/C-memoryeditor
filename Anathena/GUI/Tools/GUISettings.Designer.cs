...
namespace Ana.GUI.Tools
{
    partial class GUISettings
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.EndAddressTextBox = new HexDecTextBox();
            this.StartAddressTextBox = new HexDecTextBox();
            ...
            this.AlignmentTextBox = new HexDecTextBox();
            ...
            this.InputCorrelatorTimeOutIntervalTextBox = new HexDecTextBox();
            this.ResultsReadIntervalTextBox = new HexDecTextBox();
            this.TableReadIntervalTextBox = new HexDecTextBox();
            this.RescanIntervalTextBox = new HexDecTextBox();
            this.FreezeIntervalTextBox = new HexDecTextBox();
