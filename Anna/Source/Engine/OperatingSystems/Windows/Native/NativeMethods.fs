...
open Anna.Source.Engine.OperatingSystems.Windows.Structures
...
module NativeMethods = 
    ...
    extern Boolean IsWow64Process(IntPtr hProcess, Boolean& wow64Process)
    ...
    extern Boolean CloseHandle(IntPtr hObject)
    ...
    /// </returns>
    [<DllImport("kernel32.dll", SetLastError = true)>]
    extern Int32 GetProcessId(IntPtr hProcess)
    ...
    /// </returns>
    [<DllImport("kernel32.dll", SetLastError = true)>]
    extern IntPtr OpenProcess(ProcessAccessFlags dwDesiredAccess, Boolean bInheritHandle, Int32 dwProcessId)
    ...
    /// </returns>
    [<DllImport("kernel32.dll", SetLastError = true)>]
    extern Boolean ReadProcessMemory(IntPtr hProcess, IntPtr lpBaseAddress, Byte[] lpBuffer, Int32 dwSize, Int32& lpNumberOfBytesRead)
    ...
    /// </returns>
    [<DllImport("kernel32.dll", SetLastError = true)>]
    extern IntPtr VirtualAllocEx(IntPtr hProcess, IntPtr lpAddress, Int32 dwSize, MemoryAllocationFlags flAllocationType, MemoryProtectionFlags flProtect)
    ...
    /// </returns>
    [<DllImport("kernel32.dll", SetLastError = true)>]
    extern Boolean VirtualFreeEx(IntPtr hProcess, IntPtr lpAddress, Int32 dwSize, MemoryReleaseFlags dwFreeType)
    ...
    /// </returns>
    [<DllImport("kernel32.dll", SetLastError = true)>]
    extern Boolean VirtualProtectEx(IntPtr hProcess, IntPtr lpAddress, Int32 dwSize, MemoryProtectionFlags flNewProtect, MemoryProtectionFlags& lpflOldProtect)
    ...
    module Wrapper32 =
        [<DllImport("kernel32.dll", SetLastError = true)>]
        extern Int32 VirtualQueryEx(IntPtr hProcess, IntPtr lpAddress, MemoryBasicInformation32& lpBuffer, Int32 dwLength)
    module Wrapper64 =
        [<DllImport("kernel32.dll", SetLastError = true)>]
        extern Int32 VirtualQueryEx(IntPtr hProcess, IntPtr lpAddress, MemoryBasicInformation64& lpBuffer, Int32 dwLength)
    ...
    /// </returns>
    [<DllImport("kernel32.dll", SetLastError = true)>]
    extern Boolean WriteProcessMemory(IntPtr hProcess, IntPtr lpBaseAddress, Byte[] lpBuffer, Int32 nSize, Int32& lpNumberOfBytesWritten)