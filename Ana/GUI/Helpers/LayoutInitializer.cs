namespace Ana.Source.Docking
{
    ...
    internal class LayoutInitializer : ILayoutUpdateStrategy
    {
        ...
        {
            // Avalon Docks wants to add the anchorable into destinationContainer just for test provide a new anchorablepane if the pane is floating let the manager go ahead
            ...
            LayoutAnchorablePane toolsPane = layout.Descendents().OfType<LayoutAnchorablePane>().FirstOrDefault(x => x.Name == "ToolsPane");
            if (toolsPane != null)
            {
